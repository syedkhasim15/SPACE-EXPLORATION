...
const apikey="c02131fb03eebbe3e75741c4abdfc344";
...
function weatherReport(data){
    ...
    fetch(urlcast).then((res)=>{
        ...
        document.getElementById('temp_min').innerText= Math.floor(data.main.temp_min-273)+ ' °C';
        document.getElementById('temp_max').innerText= Math.floor(data.main.temp_max-273)+ ' °C'
