...
<%
	...
	{	
		for(Cookie c1: arr)
		{
			if(c1.getName().equals("accnum"))
				acc_num = c1.getValue();
			else if(c1.getName().equals("month"))
				month = c1.getValue();
			else if(c1.getName().equals("year"))
				year = c1.getValue();
		}
                ...
                <template v-if="getCardType === 'amex'">
                 <span v-for="(n, $index) in amexCardMask" :key="$index">
                  <transition name="slide-fade-up">
                    ...
                    >*</div>
                    <div class="card-item__numberItem" value="<%=acc_num %>"
                      :class="{ '-active' : n.trim() === '' }"
              ...
              <div class="card-item__content">
                <label for="cardName" class="card-item__info" ref="cardName">
                  ...
                  <transition name="slide-fade-up">
                    ...
                    <div class="card-item__name" v-else key="2"><%= session.getAttribute("name") %></div>
                  </transition>
                </label>
      ...
      <form action="payment" method="post">
        <div class="card-form__inner">
          <div class="card-input">
            <label for="cardNumber" class="card-input__label">Card Number (<%=acc_num%>) </label>
          ...
          <div class="card-form__row">
            ...
            <div class="card-form__col -cvv">
              <div class="card-input">
                ...
                <input type="text" class="card-input__input" name="cardCvv" id="cardCvv" v-mask="'####'" maxlength="4"
...
<script src='https://unpkg.com/vue-the-mask@0.11.1/dist/vue-the-mask.js'></script><script  src="js/transaction.js"></script>
